...
export const ServerChannel: React.FC<ServerChannelProps> = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "text-left w-32 truncate line-clamp-1 text-sm font-semibold text-zinc-500 transition group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300",
